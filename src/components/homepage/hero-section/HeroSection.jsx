...
function HeroSection() {
 const smoothScroll = () => {
  ...
  return (
    <section className="relative my-10 flex flex-col items-center justify-between py-4 lg:py-12">
      <img
        src="/hero.svg"
        alt="Hero"
        width={1572}
        ...
        <div className="order-2 lg:order-2 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-r to-pink-500 from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-pink-500 hover:to-violet-600">
              <button onClick={smoothScroll} className="px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
